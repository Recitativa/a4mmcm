...
\frame{
 ...
 Note that $\cR(\tG_1\times \tG_2) \cong \cR(\tG_1)\times \cR(\tG_2)$.
 ...
 \item $\Sp=\Sp(U\otimes U^*)$, $G=\mathrm{GL}(V)$, $G'=\mathrm{GL}(V')$ 
 \end{enumerate}
