  ...
  \begin{frame}
    ...
    \begin{column}{.48\linewidth}
      \begin{block}{Introduction and Motivation}
        ...
        \item Question: \\
          \hskip2em 
          What is the relations between derived functor module and theta?
        \item Agenda
          \begin{itemize}
          \item introduce notation in left column,
          \item give a result about the case of lifting of character 
            in right column.
          \end{itemize}
        \end{itemize}
      \end{block}
