...
\begin{figure}[p]
   %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_04a.pdf}
   \caption{Absolute error for drift $\mu=0.4$}
\label{f:ab}
\end{figure}
 
 \begin{figure}[p]
    %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_04alog.pdf}
   \caption{Logarithm of error for drift $\mu=0.4$} 
   \label{f:lab}
\end{figure}
 
 \begin{figure}[p]
   %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_04arato.pdf} % requires the graphicx packagem 
   \caption{regression result of convergence rate for drift $\mu=0.4$}
   \label{f:ratio}
\end{figure}
...
\begin{figure}[p]
   %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_15a.pdf}
   \caption{Absolute error for drift $\mu=1.5$}
\label{f:ab}
\end{figure}
 
 \begin{figure}[p]
    %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_15alog.pdf}
   \caption{Logarithm of error for drift $\mu=1.5$} 
   \label{f:lab}
\end{figure}
 
 \begin{figure}[p]
   %\centering
   \includegraphics[scale=0.8]{nout_7_27_1_15arato.pdf} % requires the graphicx packagem 
   \caption{regression result of convergence rate for drift $\mu=1.5$}
   \label{f:ratio}
\end{figure}
...
$\alpha$-quantile options, also known as quantile options, are a type of options whose payoff are functions of the quantiles of underlying asset price process. Firstly proposed in \cite{Miura}, the payoff function at maturity for a European-style $\alpha$-quantile call option with strike $K$ is 
\begin{equation}
M(\alpha,T)-K,
\end{equation}
