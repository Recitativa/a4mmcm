...
\end{figure}
 ...
 \begin{figure}[hbp]\label{f:ratio}
   \centering
   \includegraphics{nout_7_27_rato.pdf} % requires the graphicx packagem 
...
\begin{figure}[hbp]
   \centering
   \includegraphics{qnout_7_27_lines.pdf} % requires the graphicx package
   \caption{ Errors }
\end{figure}

\begin{figure}[hbp]
   \centering
   \includegraphics{qnout_7_27_llines.pdf} % requires the graphicx package
   \caption{ logarithm of Errors }
\end{figure}

\begin{figure}[hbp]
   \centering
   \includegraphics{qnout_7_27_rato.pdf} % requires the graphicx package
