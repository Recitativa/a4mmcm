...
We always write $G*$ as the dual of $G$ (written additive too), 
and we write
$(x, x *)$, for $X\in G$, $x^* \in G*$, as the value on $x$
corresponding the character  $x*$ of $G$. On-eon
come a law to identify all the bidual AVEE G (G *) * G so that there is
(x, z *> = (z * x) 
\end{document}
