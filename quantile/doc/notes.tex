...
%No empty page between chapters
...
\appendix
%remove "A" for the numbering of appandix
\gdef\thechapter{}
\chapter[Appendix]{A forward shooting grid method for a European $\alpha$-quantile option}
\label{se:fsg}
