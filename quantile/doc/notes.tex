...
The no-aribitrage principle is the fundamental of pricing of options. Black and Scholes (1972) \cite{Black:1973} is the landmark paper in this field. Merton (1973) \cite{merton1973} was the first to expand the mathematical understanding of this options pricing model and coined the term "Black-Scholes" options pricing model.  
...
\begin{equation}
dR= (\frac{\partial V}{\partial t} + \frac{1}{2}\frac{{\partial}^2}{\partial S^2} {S^2}_t {\sigma}^2 ) dt
\end{equation}
